...
class ShowModePresenterTest {
    ...
    fun startSelectTheGoodTimer() {
        ...
        timerList.add(Timer(9, 0, "timer1", ColorUtils.COLOR_AMBER, 0))
        timerList.add(Timer(10, 0, "timer2", ColorUtils.COLOR_AMBER, 1))
        timerList.add(Timer(11, 0, "timer3", ColorUtils.COLOR_AMBER, 2))
